...
\subsection{Erollment}
	...
	\begin{enumerate}
		...
		\item \textbf{Gaussian Mixture Model}
			...
			As the efficiency of GMM from scikit-learn is much more worse than PyPR,
			we did not conduct experiments on GMM from scikit-learn training UBM.
			But as we can infer, our GMM will be much-much faster than that one.
